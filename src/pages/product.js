    ...
    <section className="product">
      ...
      <div className="product__content">
        ...
        <div className="product__arrows">
          <a className="product__arrow" disabled={console.log(id === 1)}  href={`${ROUTES.BROWSE}/${product.id - 1}`}><BsArrowLeft />Prev Product</a>
          <a className="product__arrow" disabled={console.log(id === product.length)} href={`${ROUTES.BROWSE}/${product.id + 1}`}>Next Product<BsArrowRight /></a>
        </div>
